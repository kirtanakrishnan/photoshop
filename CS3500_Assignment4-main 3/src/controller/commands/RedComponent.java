...
public class RedComponent extends AbstractCommand {
  ...
  /**
   * Constructs a {@code RedComponent} through the given image, model, controller, and
   * newImage.
  ...
  /**
   * Constructs a {@code RedComponent} through the given model and view.
   * @param model the given model.
  ...
  public ImageModel doCommand(ImageModel model) throws IOException {
    ...
    if (controller == null) {
      view.renderMessage(newImage + " created through red channel of " + image + ".");
    }
