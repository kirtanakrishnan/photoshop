...
public class IntensityComponent extends AbstractCommand {
  ...
  /**
   * Constructs a {@code IntensityComponent} through the given model and view.
  ...
  /**
   * Constructs a {@code IntensityComponent} through the given image, model, controller, and
   * newImage.
