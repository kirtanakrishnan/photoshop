...
/**
 * Represents a HistogramPanel, which renders a histogram through GUI.
 */
public class HistogramPanel extends JPanel {
  ...
  /**
   * Constructs a {@code HistogramPanel} through the given view and model.
   * @param view the view used to construct the HistogramPanel.
   * @param model the model used to construct the HistogramPanel.
   */
