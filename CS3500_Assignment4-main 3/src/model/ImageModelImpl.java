...
/**
 * ImageModelImpl is an implementation of ImageModel that has a height, width,
...
public class ImageModelImpl implements ImageModel {
  ...
  /**
   * Creates a copy of an ImageModel.
   * @return the copied ImageModelImpl
   */
  @Override
  ...
  /**
   * Creates a model manipulated according to its red component.
  ...
  /**
   * Creates a model manipulated according to its green component.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Creates a model manipulated according to its blue component.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Creates a model manipulated according to its value component.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Creates a model manipulated according to its intensity component.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Creates a model manipulated according to its luma component.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Creates a model flipped horizontally.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Creates a model flipped vertically.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Creates a model brightened according the given value.
   * @return the filtered model
   */
  @Override
  ...
  /**
   * Gets the pixel at the row and col position.
   * @param row the row number
   * @param col the column number
   * @return the pixel at the row and col position.
   */
  @Override
  ...
  /**
   * Sets a pixel to the given row and col position.
   * @param row the row number
   * @param col the column number
   * @param p   the pixel
   */
